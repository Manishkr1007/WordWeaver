                        ...
                        <div className="flex flex-wrap justify-between">
                            <div className="w-full p-6 md:p-0 md:w-1/2 lg:w-2/12">
                                ...
                                <ul className="flex flex-col items-center md:flex-none md:items-start">
                                    <li className="mb-4">
                                        <Link className="text-base font-medium text-white hover:text-gray-700" to="/">
                                            Account
                                        </Link>
                                    </li>
                                    <li className="mb-4">
                                    ...
                                    <li className="mb-4">
                                        <Link className="text-base font-medium text-white hover:text-gray-700" to="/contact">
                                            Contact Us
                                        </Link>
                                    </li>
                                </ul>
                            </div>
                            <div className="w-full p-6 md:p-0 md:w-1/2 lg:w-3/12">
                                <h3 className="tracking-px mb-9 text-xs font-semibold uppercase text-white text-center md:text-left">
                                    Legals
                                </h3>
                                <ul className="flex flex-col items-center md:flex-none md:items-start">
                                ...
                                <ul className="flex space-x-6 justify-center md:justify-start">
                                    <li>
                                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                                            <FaFacebook className="text-white hover:text-gray-500" size={24} />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
                                            <FaTwitter className="text-white hover:text-gray-500" size={24} />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
                                            <FaInstagram className="text-white hover:text-gray-500" size={24} />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
                                            <FaLinkedin className="text-white hover:text-gray-500" size={24} />
                                        </a>
                                    </li>
                                </ul>
                            </div>
